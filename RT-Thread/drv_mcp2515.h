#ifndef _DRV_MCP2515_H 
#define _DRV_MCP2515_H

#include "drv_config.h"
#include "bsp_config.h"

#define MCP2515_TRUE										1
#define MCP2515_FALSE										0
...
typedef struct
{
  void (*mcp_2515_cs_high)(void);
	void (*mcp_2515_cs_low)(void);
	uint8_t (*mcp_2515_send_data)(uint8_t ucValue);
}MCP2515_FUN;

extern MCP2515_FUN mcp2515_fun;
